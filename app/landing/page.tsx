      ...
      <nav className="sticky top-0 z-50 w-full border-b border-dark-border bg-dark-card/80 backdrop-blur-md">
        <div className="flex h-16 items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/signin"
              className="px-4 py-2 rounded-lg bg-blue-gradient text-white font-medium hover:shadow-blue-glow transition-all"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <Link
                href="/signin"
                className="group flex items-center gap-2 px-8 py-4 rounded-lg bg-blue-gradient text-white font-semibold text-lg hover:shadow-blue-glow transition-all"
              >
                Start Trading Now
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-gradient mb-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/signin"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-blue-gradient text-white font-semibold text-lg hover:shadow-blue-glow transition-all"
              >
                Create Free Account
